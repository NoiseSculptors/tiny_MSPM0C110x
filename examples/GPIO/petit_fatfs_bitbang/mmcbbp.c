...
#define	CS_H()		bset(SPI_CS)	/* Set MMC CS "high" */
#define CS_L()		bclr(SPI_CS)	/* Set MMC CS "low" */
#define CK_H()		bset(SPI_CK)	/* Set MMC SCLK "high" */
#define	CK_L()		bclr(SPI_CK)	/* Set MMC SCLK "low" */
#define DI_H()		bset(SPI_MOSI)	/* Set MMC DI "high" */
#define DI_L()		bclr(SPI_MOSI)	/* Set MMC DI "low" */
#define DO			btest(SPI_MISO)	/* Test MMC DO (high:true, low:false) */
